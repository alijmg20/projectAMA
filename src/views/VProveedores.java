...
public class VProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LineaSuminist1 = new javax.swing.JComboBox<>();
        LineaSuminist2 = new javax.swing.JComboBox<>();
        LineaSuminist3 = new javax.swing.JComboBox<>();
        ...
        LineaSuminist1.setEditable(true);
        ...
        LineaSuminist2.setEditable(true);
        ...
        LineaSuminist3.setEditable(true);
    ...
    private void tableProveedoresMouseClicked(java.awt.event.MouseEvent evt) {                                              
        ...
        correo1i= this.FieldMail1.getText();
        correo2i= this.FieldMail2.getText(); 
        correo3i= this.FieldMail3.getText();
        tl1=this.FieldTlf1.getText();
        tl2=this.FieldTlf2.getText();
        tl3=this.FieldTlf3.getText(); 
        li1=this.LineaSuminist1.getSelectedItem().toString();
        li2=this.LineaSuminist2.getSelectedItem().toString();
        li3=this.LineaSuminist3.getSelectedItem().toString();
               //desactivo los correos que no se pueden modificar (vacios)
                if (this.FieldMail1.getText().isEmpty())
                    this.FieldMail1.disable();
                if (this.FieldMail2.getText().isEmpty())
                    this.FieldMail2.disable();
                if (this.FieldMail3.getText().isEmpty())
                    this.FieldMail3.disable();
                //desactivo los telefonos que no se pueden modificar (vacios)
                if (this.FieldTlf1.getText().isEmpty())
                    this.FieldTlf1.disable();
                if (this.FieldTlf2.getText().isEmpty())
                    this.FieldTlf2.disable();
                if (this.FieldTlf3.getText().isEmpty())
                    this.FieldTlf3.disable();
                //desactivo las lineas de suministro que no se pueden modificar (vacios)
                if (this.LineaSuminist1.getSelectedIndex()==0)
                    this.LineaSuminist1.disable();
                else 
                    this.LineaSuminist1.enable();
                if (this.LineaSuminist2.getSelectedIndex()==0)
                    this.LineaSuminist2.disable();
                else 
                    this.LineaSuminist2.enable();
                if (this.LineaSuminist3.getSelectedIndex()==0)
                    this.LineaSuminist3.disable();
                else 
                    this.LineaSuminist3.enable();
    ...
    private void MasMailActionPerformed(java.awt.event.ActionEvent evt) {                                        
    ...
    private void MasTlfActionPerformed(java.awt.event.ActionEvent evt) {                                       
    ...
    private void LineaSuminist1ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void FieldMail2ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
       // FieldMail2.setVisible(true);
    }                                          

    private void FieldMail3ActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
     
    }                                          

    private void FieldTlf2ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void FieldTlf3ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void LineaSumiActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
    }                                          

    private void LineaSuminist2ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void LineaSuminist3ActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
    }                                              

    private void VerInfoActionPerformed(java.awt.event.ActionEvent evt) {                                        
        // TODO add your handling code here:
    }                                       

    private void VerInfoMouseClicked(java.awt.event.MouseEvent evt) {                                     
        // TODO add your handling code here:
    ...
    private void FieldRIFActionPerformed(java.awt.event.ActionEvent evt) {                                         
        // TODO add your handling code here:
    }                                        
...
public class VProveedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addComponent(btnVolver1, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
        );
    ...
    private void ActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActualizarActionPerformed
            ...
            if (decision == 0) { //Caso que se acepte.
                ...
                prov.actualizarDatosCorreos(RIF,MAIL1,MAIL2,MAIL3);
